  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Obx(() => _loadingState.loading.value
                ...
                : _homeController.errorMessage.value == null
                    ? _widgetMain()
                    : const Center(
                        child: Text(
  ...
  Widget _widgetMain() {
    if (_homeController.restaurantHeader.value == null) {
      ...
      return ListView.builder(
        itemCount: _homeController.restaurantHeader.value!.restaurants.length,
        itemBuilder: (context, index) {
          var restaurantItem =
              _homeController.restaurantHeader.value!.restaurants[index];
